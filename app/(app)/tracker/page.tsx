    ...
    return (
      <div className="max-w-4xl mx-auto px-5 lg:px-8 py-8">
        <div className="text-center py-20 text-zinc-400">
          <div className="w-6 h-6 border-2 border-zinc-200 border-t-blue-500 rounded-full animate-spin mx-auto mb-3" />
    ...
    <div className="max-w-4xl mx-auto px-5 lg:px-8 py-8">
        ...
        <div className="flex items-end gap-2 h-28">
          {weeklyActivity.map((day, i) => (
            <div key={i} className="flex-1 flex flex-col items-center gap-1.5">
              ...
              {day.count > 0 && (
                <span className="text-[10px] font-bold text-blue-700">{day.count}</span>
              )}
            </div>
          ))}
        </div>
                  ...
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-3">
                      <div className="flex-1 min-w-0">
                        <h3 className="text-sm font-semibold text-zinc-900 group-hover:text-blue-800 transition-colors truncate">{pod.name}</h3>
                    ...
                    <div className="flex items-center gap-3 flex-shrink-0">
                      {pod.currentStreak > 0 && (
                        <div className="flex items-center gap-1 bg-blue-50 border border-blue-100 rounded-full px-2 py-0.5">
                          ...
                          <span className="text-xs font-bold text-blue-800">{pod.currentStreak}</span>
                        </div>
                      )}
      ...
      <div className="bg-zinc-900 rounded-3xl p-6 text-center">
        <div className="flex items-center justify-center gap-2 mb-2">
          ...
          <Medal size={16} weight="fill" className="text-blue-500" />
        </div>
