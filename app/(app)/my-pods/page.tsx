                  ...
                  <div className="absolute bottom-3 left-4 right-4 flex items-end justify-between">
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-0.5">
                        <span className={`text-[10px] font-semibold tracking-wide uppercase px-2 py-0.5 rounded-full ${pod.type === "Habit" ? "bg-blue-500/80 text-white" : "bg-emerald-500/80 text-white"}`}>
                          {pod.type}
                        </span>
                        {pod.isAdmin && (
                          <span className="flex items-center gap-0.5 text-[10px] font-semibold text-blue-300">
