  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (!error) {
        ...
        const typeColor = type === "reminder" ? { bg: "bg-blue-500", text: "text-white" } : { bg: "bg-zinc-700", text: "text-white" }
        onAdd({
          id: `user-${Date.now()}`,
          title: title.trim(),
          date,
    ...
    <div className="bg-white border border-zinc-100 rounded-2xl p-4 shadow-card mb-4">
      ...
      <div className="space-y-2.5">
        <input
          ...
          className="w-full bg-zinc-50 border border-zinc-200 rounded-xl px-3 py-2 text-sm text-zinc-900 placeholder:text-zinc-400 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
        />
        <div className="grid grid-cols-2 gap-2">
          <input
            ...
            className="bg-zinc-50 border border-zinc-200 rounded-xl px-3 py-2 text-sm text-zinc-700 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
          />
          <input
            type="time"
            value={time}
        ...
        {type === "pod" && (
          <select
            ...
            className="w-full bg-zinc-50 border border-zinc-200 rounded-xl px-3 py-2 text-sm text-zinc-700 outline-none focus:border-blue-500"
          >
        ...
        <textarea
          ...
          rows={2}
          className="w-full bg-zinc-50 border border-zinc-200 rounded-xl px-3 py-2 text-sm text-zinc-900 placeholder:text-zinc-400 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 resize-none"
        />
        <button
              ...
              return (
                ...
                >
                  ...
                  <span className={`text-xs font-semibold w-6 h-6 flex items-center justify-center rounded-full mb-1 flex-shrink-0
                    ${today_ && !selected_ ? "bg-blue-500 text-white" : ""}
