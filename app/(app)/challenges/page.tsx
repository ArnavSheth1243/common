          ...
          {myChallenges.length > 0 && (
            <div className="mb-8">
              <h2 className="text-xs font-semibold text-zinc-400 uppercase tracking-widest mb-4">
                <Lightning size={12} weight="fill" className="inline mr-1 text-amber-500" />
                    ...
                    <div key={c.id} className="bg-white border border-zinc-100 rounded-2xl p-5 shadow-softer">
                      <div className="flex items-start justify-between mb-3">
                        <div>
                          ...
                          <Link href={`/pods/${c.podId}`} className="text-xs text-zinc-400 hover:text-amber-600 transition-colors">
                            {c.podName}
                          </Link>
                        </div>
